...
class App extends Component {
  ...
  // displayPending = status => {
  //   if (status) {
  //     return this.setState({ viewPending: true });
  //   }
  //   return this.setState({ viewPending: false });
  // };
  ...
  renderTabList = () => {
    return (
      <div className="my-5 tab-list">
        ...
        {/* <span
          onClick={() => this.displayPending(true)}
          className={this.state.viewCompleted ? "active" : ""}
        >
          Pending
        </span> */}
  ...
  // Create item
  createItem = () => {
    const item = { title: "", description: "", pending: false, completed: false };
