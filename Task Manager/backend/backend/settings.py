...
SECRET_KEY = 'django-insecure-jgs@$zr4*tqq27-vjcnoywjew&ez@-a@)42)$^yg3=t)x6y=mn'
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'noreply.one@gmail.com'
EMAIL_HOST_PASSWORD = 'ihshkufgldfyurbirglufgftvikpevdfudfxpssdi'
EMAIL_USE_TLS = True
...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        {"name": "Task",  "url": "/admin/mainApp/task/",
            "permissions": ["auth.view_user"]},
        {"name": "Team",  "url": "/admin/mainApp/team/",
            "permissions": ["auth.view_user"]},



        # external url that opens in a new window (Permissions can be added)
        {"name": "Support", "url": "https://github.com/extinctCoder",
            "new_window": True},
